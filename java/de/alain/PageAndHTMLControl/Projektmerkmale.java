...
public class Projektmerkmale extends Base {
	...
	public static String ProjektTitle() {
		return selectgetText(ProjektTitle, 10);
	}

	public static String GeplanterStart() {
		return selectgetText(GeplanterStart, 10);
	}

	public static String VoraussichtlichesEnde() {
		return selectgetText(VoraussichtlichesEnde, 10);
	}

	public static String ProjektOrt() {
		return selectgetText(ProjektOrt, 10);
	}

	public static String StundenSatz() {
		return selectgetText(StundenSatz, 10);
	}

	public static String LetzteUpdate() {
		return selectgetText(LetzteUpdate, 10);
	}

	public static String Remote() {
		return selectgetText(RemoteArbeit, 10);
	}

	public static String RefenrenzNummer() {
		return selectgetText(RefenrenzNummer, 10);
	}

	public static String Projektbeschreibung() {
		return selectgetText(projektbeschreibung, 10);
	}
	...
	public static String OriginalTitle_GeplanterStart() {
		...
		return selectgetAttributdataOriginalTitle(OriginalTitle_GeplanterStart, 10);
	}

	public static String OriginalTitle_VoraussichtlichesEnde() {
		return selectgetAttributdataOriginalTitle(OriginalTitle_VoraussichtlichesEnde, 10);
	}

	public static String OriginalTitle_ProjektOrt() {
		return selectgetAttributdataOriginalTitle(OriginalTitle_ProjektOrt, 10);
	}

	public static String OriginalTitle_StundenSatz() {

		return selectgetAttributdataOriginalTitle(OriginalTitle_StundenSatz, 10);
	}

	public static String OriginalTitle_LetzteUpdate() {
		return selectgetAttributdataOriginalTitle(OriginalTitle_LetzteUpdate, 10);
	}

	public static String OriginalTitle_RefenrenzNummer() {
		return selectgetAttributdataOriginalTitle(OriginalTitle_RefenrenzNummer, 10);
	}

	public static String OriginalTitle_Remote() {
		return selectgetAttributdataOriginalTitle(OriginalTitle_Remote, 10);
	}
